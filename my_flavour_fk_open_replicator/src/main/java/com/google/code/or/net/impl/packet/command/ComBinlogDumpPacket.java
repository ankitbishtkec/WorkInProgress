...
public class ComBinlogDumpPacket extends AbstractCommandPacket
{
	...
	{
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("binlogPosition", binlogPosition)
		        .append("binlogFlag", binlogFlag).append("serverId", serverId).append("binlogFileName", binlogFileName)
		        .toString();
	}
